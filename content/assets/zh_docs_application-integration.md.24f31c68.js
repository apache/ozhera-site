...
</code></pre><p><img src="`+x+'" alt="log-tail3"></p><p><img src="'+C+'" alt="log-tail4"></p><h2 id="首页关注应用" tabindex="-1">首页关注应用 <a class="header-anchor" href="#首页关注应用" aria-label="Permalink to &quot;首页关注应用&quot;">​</a></h2><p>在首页添加应用到“我参与的应用”或者“我关注的应用”后，就可以查看监控、链路信息了。</p><p><img src="'+O+'" alt="hera-dash1"></p><p><img src="'+f+'" alt="hera-dash2"></p><p><img src="'+N+'" alt="hera-dash3"></p>',82),I=[B,z,H];function R($,w,V,J,Q,K){return S(),T("div",null,I)}const L=j(M,[["render",R]]);export{Y as __pageData,L as default};
